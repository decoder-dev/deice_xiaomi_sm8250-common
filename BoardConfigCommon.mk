...
TARGET_KERNEL_SOURCE := kernel/xiaomi/munch1
TARGET_KERNEL_ARCH := arm64
KERNEL_LD := LD=ld.lld
TARGET_KERNEL_CLANG_VERSION := lastest
TARGET_KERNEL_CLANG_PATH := $(shell pwd)/prebuilts/clang/host/linux-x86/clang-lastest
